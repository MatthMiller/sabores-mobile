      ...
      <View style={styles.card}>
        ...
        <View style={styles.loginInputs}>
          <View style={styles.inputContainer}>
            ...
            <TextInput
              onFocus={() =>
                setIsFormOnFocus({ password: false, email: false, nome: true })
              }
              style={
                isFormOnFocus.nome
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              onFocus={() =>
                setIsFormOnFocus({ password: false, email: true, nome: false })
              }
              style={
                isFormOnFocus.email
                  ? [styles.input, styles.inputFocused]
        ...
        <View style={styles.bottomInfo}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.hintText}>Já possui conta? Login.</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.7} style={styles.filledButton}>
            <Text style={styles.filledButtonText}>Cadastrar</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
